...
public class MenuController {
    ...
    public ResponseResult addMenu(HttpServletRequest request){
        ...
        if(map.get("parentId") == null){
            ...
            menu.setMenuName(map.get("currMenuName").toString());
            menu.setUrl(map.get("currMenuUrl").toString());
    ...
    public ResponseResult updateMenu(HttpServletRequest request){
        ...
        menu.setUrl(map.get("menuUrl").toString());
        menu.setId(Long.valueOf(map.get("Id").toString()));
    ...
    public ResponseResult deleteMenu(HttpServletRequest request){
