...
<script type="text/ecmascript-6">
  export default {
    name: "newUpdateShiJuan",
    data() {
      return {
        editor11: null, //富文本编辑器1
        editor22: null, //富文本编辑器2
    ...
    methods:{
      ...
      onSubmit(formInline) { //添加
        ...
        this.$refs[formInline].validate((valid) => {
          if (valid) {
            ...
            //试题题干
            formInfo.tigan = this.editor11.getContent();
            //试题设置
            ...
            //试题分析
            formInfo.fenxi = this.editor22.getContent();
      ...
      initEditorInfo() {   //初始化富文本编辑器
        //初始化富文本编辑器start
        //初始化编辑工具的宽高
        let config11 = {initialFrameWidth: 600, initialFrameHeight: 100};
        let config22 = {initialFrameWidth: 600, initialFrameHeight: 100};
        //初始化editor11  addListener:作用是监听富文本编辑器中的内容
    ...
    mounted() {
      ...
      this.$emit("newUpdateInfo");
      this.getFormInfoById();
    },
